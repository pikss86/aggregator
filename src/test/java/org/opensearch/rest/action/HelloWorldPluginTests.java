...
public class HelloWorldPluginTests extends OpenSearchTestCase {
    public void testBuildHelloWorldResponse() {
        ...
        String funcName = "avg";
        String indexName = "testData";
        assertThat(HelloWorldService.buildResponse(name, funcName, indexName).content().utf8ToString(),
                equalTo("Hi " + name + "! Your plugin is installed and working:)\n"
                        + "functionName: " + funcName + "indexName:" + indexName));
    }
}